...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
# 7. ログ転送機能の確認（Phase 5.3）
echo "📋 7. ログ転送機能の確認（Phase 5.3）"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
if docker-compose ps fluentd 2>/dev/null | grep -q "Up"; then
    echo "✅ Fluentdが起動しています"
    echo "   詳細なテストを実行するには以下を実行してください:"
    echo "   ${SCRIPT_DIR}/test-phase5-3.sh"
else
    echo "ℹ️  Fluentdは起動していません（オプション）"
fi
echo ""
...
echo "  - Phase 5.3: ${SCRIPT_DIR}/test-phase5-3.sh"
